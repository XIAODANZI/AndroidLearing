...
public class CustomAlertController {
	...
	private void setupView() {
		...
		//TypedArray a = mContext.obtainStyledAttributes(null, null, android.R.attr.alertDialogStyle, 0);
		TypedArray a = null;
	...
	private boolean setupButtons() {
		...
		if (TextUtils.isEmpty(mButtonNeutralText)) {
			...
			mButtonNeutral.setGravity(Gravity.CENTER);
	...
	private void centerButton(Button button) {
		...
		leftSpacer.setVisibility(View.VISIBLE); //显示左右spacer
		View rightSpacer = mWindow.findViewById(R.id.rightSpacer);
		rightSpacer.setVisibility(View.VISIBLE); //显示左右spacer
	}
